...
import { chainsToContracts, cappyTokenAbi, marketplaceAbi } from "@/app/constants"
...
export default function BuyNftPage() {
    ...
    const usdcAddress = (chainsToContracts[chainId]?.capyToken as Address) || "0x";
    ...
    const { data: listingData, isLoading: isListingLoading } = useReadContract({
        ...
        args: [ contractAddress as Address, BigInt(tokenId) ],
    })
        ...
        <div className="min-h-screen bg-zinc-50 flex flex-col">
            <main className="flex-1 container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-3xl font-bold mb-6 text-white flamenco-font">Buy NFT</h1>
